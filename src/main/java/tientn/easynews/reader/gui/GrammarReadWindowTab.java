...
public class GrammarReadWindowTab extends SimpleFormBase {
    ...
    private void createMainSectionElements() {
        ...
        HBox coinRow = new HBox(lblCoin, lblJCoinAmount, new Label("STC:"), lblCurrentSentenceValue,
    ...
    private void autoSelectNextPattern() {
    ...
    private void selectPattern(final String patId) {
        ...
        appendTextToContent(sb.toString(), false);
